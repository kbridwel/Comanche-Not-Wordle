export const CONFIG = {
  ...
  authorWebsite: 'https://www.talkcomanche.org', // Put a link to your website or social media here
  wordListSource: 'CLCPC Dictionary', // Describe the source material for your words here
